...
app = modal.App(name="soprano-model-uploader")

MODEL_PATH = "/models"
volume = modal.Volume.from_name("TTS-assets", create_if_missing=True)
...
def download_models():
    models_config = [
        {
            "model_id": "",  # TODO: Add Soprano TTS model ID from HuggingFace (if needed)
